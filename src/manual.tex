...
Для оформления библиографических ссылок используются стили |disser.bst| и |disser-s.bst|. Они представляют собой доработанные версии |gost71u.bst| и |gost71s.bst| из пакета |gost|, написанного Максимом Поляковым.
...
В зависимости от кодировки, использованной в bib-файле, необходимо подключать тот или иной файл с описанием кодовой страницы и порядка сортировки (csf-файл), например, |koi8u.csf| или |cp1251.csf|.
...
Данный стиль позволяет менять префикс номера ссылок, т.\,е. использовать ссылки вида [A1] вместо [1].
Эта возможность необходима поскольку в автореферате следует различать ссылки на работы соискателя и на внешние источники.
...
В данном случае ссылки на библиографию будут иметь вид [A$n$], где $n$ "--- номер.
